...
@RoutePage()
class MyVpnsScreen extends StatefulWidget {
  const MyVpnsScreen({super.key});

  @override
  State<MyVpnsScreen> createState() => _MyVpnsScreenState();
}

class _MyVpnsScreenState extends State<MyVpnsScreen> {
  final TextEditingController _searchController = TextEditingController();

  final DataVpnsBloc _loadVpnsBloc = DataVpnsBloc();
  final FilterVpnType _filter = FilterVpnType.mine;
  TabsRouter? _tabsRouter;

  static const int _routeTabIndex = 1;
    ...
    switch (vpnsList.items[index]) {
      ...
      case VpnListItem():
        ...
        return CardVpnList(
          ...
          isShowDeleteButton: !vpn.isActive,
          onLikeTap: () {
